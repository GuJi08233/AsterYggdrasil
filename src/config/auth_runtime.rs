...
pub use crate::config::definitions::{
    AUTH_ACCESS_TOKEN_TTL_SECS_KEY, AUTH_ALLOW_LOCAL_LOGIN_KEY, AUTH_ALLOW_LOCAL_REGISTRATION_KEY,
...
pub const DEFAULT_AUTH_ALLOW_LOCAL_LOGIN: bool = true;
...
impl RuntimeAuthPolicy {
    pub fn from_runtime_config(runtime_config: &RuntimeConfig) -> Self {
        ...
        let allow_local_login = forge_read_bool(
            runtime_config,
            AUTH_ALLOW_LOCAL_LOGIN_KEY,
            DEFAULT_AUTH_ALLOW_LOCAL_LOGIN,
        );
