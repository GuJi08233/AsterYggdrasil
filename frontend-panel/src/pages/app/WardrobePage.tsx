...
import { useWardrobePageState } from "@/components/app/wardrobe-page/useWardrobePageState";
import { Field, NativeSelectField } from "@/components/panel/FormControls";
...
export default function WardrobePage() {
	...
	const [state, dispatch] = useWardrobePageState();
	const {
		activeTexture,
		deleteDialogOpen,
		deleteTexture,
