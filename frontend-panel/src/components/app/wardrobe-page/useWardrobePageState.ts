...
export type WardrobePageAction =
...
const initialState: WardrobePageState = {
	activeTexture: null,
...
function reducer(
	state: WardrobePageState,
	action: WardrobePageAction,
): WardrobePageState {
	switch (action.type) {
		case "activeTexture":
...
export function useWardrobePageState() {
